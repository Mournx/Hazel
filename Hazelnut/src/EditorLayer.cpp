...
namespace Hazel {
	...
	void EditorLayer::OnAttach()
	{
		...
		m_FirstCamera = m_ActiveScene->CreateEntity("Camera A");
	...
	void EditorLayer::UI_Toolbar()
	{
		...
		ImGui::Begin("##toolbar", nullptr, ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoDecoration | ImGuiWindowFlags_NoScrollWithMouse);
