...
void Sandbox2D::OnAttach()
{
	...
	m_SpriteStairs = Hazel::SubTexture2D::CreateFromCoords(m_SpriteSheet, { 7, 6 }, { 128, 128 });
	...
	m_CameraController.SetZoomLevel(6.6f);
}
...
void Sandbox2D::OnUpdate(Hazel::Timestep ts)
{
...
#if 0
	{
	    ...
	    Hazel::Renderer2D::DrawRotatedQuad({ 1.0f, 0.0f }, { 0.75f, 0.5f }, glm::radians(- 45.0f), {0.8f, 0.2f, 0.3f, 1.0f});
	...
	for (uint32_t y = 0; y < m_MapHeight; y++)
	{
		for (uint32_t x = 0; x < m_MapWidth; x++)
		{
			...
			if (s_TextureMap.find(tileType) != s_TextureMap.end())
				...
				texture = m_SpriteBarrel;

			Hazel::Renderer2D::DrawQuad({ x - m_MapWidth * 0.5f, m_MapHeight * 0.5f - y, 0.5f }, { 1.0f, 1.0f }, texture);
		}
	}
	//Hazel::Renderer2D::DrawQuad({ 0.0f, 0.0f, 0.5f }, { 1.0f, 1.0f }, m_SpriteStairs);
	//Hazel::Renderer2D::DrawQuad({ 1.0f, 0.0f, 0.5f }, { 1.0f, 1.0f }, m_SpriteBarrel);
	//Hazel::Renderer2D::DrawQuad({ -1.0f, 0.0f, 0.5f }, { 1.0f, 2.0f }, m_SpriteTree);
	Hazel::Renderer2D::EndScene();
}
